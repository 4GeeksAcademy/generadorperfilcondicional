...
function render(variables = {}) {
  ...
  //condición ? acción si se cumple la condición : acción si no se cumple la condición
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.lastName != null ? variables.lastName : "Apellido"
          ...
          <h2>${variables.role != null ? variables.role : "Rol"}</h2>
          <h3>${variables.country != null ? variables.country : "País"} ${
    variables.city != null ? variables.city : "Ciudad"
  } </h3>
        <ul class=${
